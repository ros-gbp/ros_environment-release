## ros_environment (noetic) - 1.3.2-1

The packages in the `ros_environment` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic ros_environment` on `Mon, 28 Sep 2020 20:51:46 -0000`
...
## ros_environment (kinetic) - 1.0.1-1
